...
_SOURCE_HEALTH_CODES = frozenset({
    ...
    "GITHUB_AUTH_UNAVAILABLE", "GITHUB_RATE_LIMITED", "GITHUB_SOURCE_UNAVAILABLE",
    "GITHUB_VERIFICATION_FAILED", "GITHUB_RESPONSE_INVALID",
    "GITHUB_POLL_BUDGET_EXHAUSTED", "GITHUB_COVERAGE_UNPROVEN",
    "GITHUB_HISTORY_GAP", "GITHUB_PAGINATION_INVALID", "STORE_UNAVAILABLE",
})
